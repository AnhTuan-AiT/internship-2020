...
public class ProductController {
    ...
    public ResponseEntity<?> filterCategoriesByName(@RequestParam String categoryName, @RequestParam Integer pageNumber) {
        if (pageNumber == null) {
            return new ResponseEntity("Require page number", HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> getCategories(@RequestParam Integer pageNumber) {
        if (pageNumber == null) {
            return new ResponseEntity("Require page number", HttpStatus.BAD_REQUEST);
        }
        ...
        return ResponseEntity.ok().body(categoryService.getCategories(pageNumber));
    }
    ...
    public ResponseEntity<?> getAllProductsOfCategory(@RequestParam Integer categoryId, @RequestParam Integer pageNumber) {
        return ResponseEntity.ok().body(productService.getPageProductsOfCategory(categoryId, pageNumber));
    }
}
